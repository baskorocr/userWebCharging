 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item">
              <a href="{{ route('user.history') }}" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-history"></i>
                <div data-i18n="Layouts">History Transaction</div>
              </a>
            </li>
               <li class="menu-item">
              <a href="#" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-gas-pump"></i>
                <div data-i18n="Layouts">Monitoring Charging</div>
              </a>
            </li>
             <li class="menu-item">
              <a href="{{ route('user.map') }}" class="menu-link ">
                <i class="menu-icon tf-icons bx bxs-map"></i>
                <div data-i18n="Layouts">Map Charging</div>
              </a>
            </li>
